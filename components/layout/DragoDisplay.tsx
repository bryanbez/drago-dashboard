...
import { searchDragos } from "@/app/lib/utils/dragoDisplay";
import { useSearchDragoStore } from "@/app/lib/stores/storeSearchDrago";
import { SearchDragosTextbox } from "../partials/Search/SearchTextbox";
...
export const DragoDisplay = () => {
  ...
  let displayDragos: DragoInfo[] = dragos;

  if (searchDrago) {
    displayDragos = searchDragos(dragos, searchDrago);
  }

  displayDragos = displayDragos.filter(
    (drago) =>
